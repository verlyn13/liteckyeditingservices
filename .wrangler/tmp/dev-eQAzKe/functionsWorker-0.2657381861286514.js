...
// .wrangler/tmp/pages-NKWJvT/functionsWorker-0.2657381861286514.mjs
...
var onRequestPost = /* @__PURE__ */ __name2(async ({
  request,
  env: env2
}) => {
  try {
...
var onRequest = /* @__PURE__ */ __name2(async (context22) => {
  const res = await context22.next();
...
// .wrangler/tmp/bundle-ZEHYuY/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-ZEHYuY/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.2657381861286514.js.map

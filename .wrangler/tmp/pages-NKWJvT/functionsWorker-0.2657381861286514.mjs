...
// ../node_modules/.pnpm/@cloudflare+unenv-preset@2.7.5_unenv@2.0.0-rc.21_workerd@1.20250927.0/node_modules/@cloudflare/unenv-preset/dist/runtime/polyfill/performance.mjs
...
// ../node_modules/.pnpm/@cloudflare+unenv-preset@2.7.5_unenv@2.0.0-rc.21_workerd@1.20250927.0/node_modules/@cloudflare/unenv-preset/dist/runtime/node/console.mjs
...
// ../node_modules/.pnpm/wrangler@4.40.3_@cloudflare+workers-types@4.20251001.0/node_modules/wrangler/_virtual_unenv_global_polyfill-@cloudflare-unenv-preset-node-console
...
// ../node_modules/.pnpm/@cloudflare+unenv-preset@2.7.5_unenv@2.0.0-rc.21_workerd@1.20250927.0/node_modules/@cloudflare/unenv-preset/dist/runtime/node/process.mjs
...
// ../node_modules/.pnpm/wrangler@4.40.3_@cloudflare+workers-types@4.20251001.0/node_modules/wrangler/_virtual_unenv_global_polyfill-@cloudflare-unenv-preset-node-process
...
var onRequestGet = /* @__PURE__ */ __name(async (ctx) => {
  ...
  const state = incomingState || Array.from(crypto.getRandomValues(new Uint8Array(16))).map((b) => b.toString(16).padStart(2, "0")).join("");
...
function parseCookies(h) {
  const out = {};
  (h || "").split(";").map((c) => c.trim()).forEach((c) => {
    const i = c.indexOf("=");
...
var onRequestGet2 = /* @__PURE__ */ __name(async (ctx) => {
  ...
  const targets = Array.from(
    new Set([decapOrigin, url.origin].filter(Boolean))
  );
...
var onRequestPost = /* @__PURE__ */ __name(async ({
  ...
  try {
    ...
    const queue = env2.SEND_EMAIL;
    if (queue && typeof queue.send === "function") {
      await queue.send({ kind: "contact", data });
      return json({ status: "enqueued" }, 202);
    }
    const apiKey = env2.SENDGRID_API_KEY;
    const to = env2.SENDGRID_TO;
    const from = env2.SENDGRID_FROM;
    if (apiKey && to && from) {
      const payload = {
        personalizations: [
          {
...
// ../.wrangler/tmp/pages-NKWJvT/functionsRoutes-0.6263321860944966.mjs
var routes = [
  {
    routePath: "/api/auth",
    mountPath: "/api",
...
// ../node_modules/.pnpm/wrangler@4.40.3_@cloudflare+workers-types@4.20251001.0/node_modules/wrangler/templates/pages-template-worker.ts
var escapeRegex = /[.+?^${}()|[\]\\]/g;
...
// ../node_modules/.pnpm/wrangler@4.40.3_@cloudflare+workers-types@4.20251001.0/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../node_modules/.pnpm/wrangler@4.40.3_@cloudflare+workers-types@4.20251001.0/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// ../.wrangler/tmp/bundle-pl07xJ/middleware-insertion-facade.js
...
// ../node_modules/.pnpm/wrangler@4.40.3_@cloudflare+workers-types@4.20251001.0/node_modules/wrangler/templates/middleware/common.ts
...
// ../.wrangler/tmp/bundle-pl07xJ/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.2657381861286514.mjs.map

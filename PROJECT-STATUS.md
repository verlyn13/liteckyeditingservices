...
**December 9 Update (UX Changes)**: ✅ **UX IMPROVEMENTS** - Fixed CMS bug where ProcessSnapshot wasn't using CMS data (was using hardcoded defaults); removed TrustBar from homepage; removed Process page from site/navigation; enhanced About page with CMS-driven content and photo support; added Page Settings collection to CMS for Home and About page editing.

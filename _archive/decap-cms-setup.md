  ...
  - name: 'pages'
    ...
    fields:
      ...
      - {
          ...
          widget: 'text',
          required: true,
          hint: 'Brief description for navigation and SEO',
        }
      - {
          label: 'Hero Title',
          name: 'heroTitle',
          widget: 'string',
          required: false,
          hint: 'Large title shown at top of page (defaults to Title)',
        }
      ...
      - {
          ...
          widget: 'string',
          required: false,
          hint: 'For search results (defaults to Title)',
        }
      - {
  ...
  - name: 'testimonials'
    ...
    fields:
      ...
      - {
          ...
          widget: 'markdown',
          required: false,
          hint: 'Extended version for testimonials page',
        }
  ...
  <div class="section container">
    {
      page.data.heroTitle && (
        <header class="page-hero">
          ...
          {page.data.heroSubtitle && <p class="hero-subtitle">{page.data.heroSubtitle}</p>}
        </header>
      )
    }
